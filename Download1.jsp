...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
          ...
          <h2><span class="style4">File Privacy Details   </span> <span class="style5">-----  </span><a href="EndUserMainjsp.jsp">Back</a></h2>
          ...
          <%
				...
				ResultSet rs = connection.createStatement().executeQuery(strQuery);
					...
					String keys = "ef50a0ef2c3e3a5f";
						byte[] keyValue1 = keys.getBytes();
      					...
      					String td = new String(Base64.decode(trapdoor.getBytes()));
						String sk1 = new String(Base64.decode(sk.getBytes()));
						String strQuery2 = "insert into transaction(user,fname,sk,task,dt) values('"+user+"','"+file+"','"+sk1+"','"+task+"','"+dt+"')";
            ...
            <table width="478" border="0" align="center">
              <tr>
                <td width="223"><span class="style12 style5"><em><strong>Enter File Name :-</strong></em></span></td>
                <td width="245"><label>
                  <input required name="t1" type="text" value="<%=file%>" size="40" />
                </label></td>
              </tr>
              <tr>
                <td height="34"><span class="style12 style5"><em><strong>Trapdoor :-</strong></em></span></td>
                <td><input name="t12" type="text" value="<%=td%>" size="40" /></td>
              </tr>
              <tr>
                <td><span class="style12 style5"><em><strong>Secret Key :-</strong></em></span></td>
                <td><input name="t13" type="text" value="<%=sk1%>" size="40" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td><label>
                <input type="submit" name="Submit2" value="Verify and Download" />
                </label></td>
              </tr>
            </table>
          </form>		
