...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style1"> Trapdoor unlinkability Verification Details </h2>
          <p>&nbsp;</p>
		  <%
	 	...
	 	try {
		    ...
		    String keys = "ef50a0ef2c3e3a5f";
	 		...
	 		if (rs.next()) {
				...
				td = new String(Base64.decode(rs.getString("trapdoor").getBytes()));
...
<%				
					...
					String strQuery3 = "Select * FROM ownerfiles where fname='"
							...
							if(td.equals(ownermac) )
							{
							%>
<p>
<h1>No Change in Trapdoor !!! So No data is modified</h1>
</p>
