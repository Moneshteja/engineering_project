...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
          ...
          <h2><span class="style4">Verify Your Secret Key </span> <span class="style5">-----  </span><a href="CloudServerMain.html">Back</a></h2>
         
          
          <form id="form1" name="form1" method="post" action="ConfirmVerifySK.jsp">
          <table width="598" border="1" align="center" cellpadding="10" cellspacing="0">
           
            <tr>
              <td class="style1 style4"><span class="style6">File Name :- </span></td>
            ...
            <tr>
              ...
              <td><input name="Submit" type="submit" class="style4" value="Verify Sk" /></td>
            </tr>
          </table>
          </form>
