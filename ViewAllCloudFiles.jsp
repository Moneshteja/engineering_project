...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
          ...
          <h2><span class="style4">View Attribute Based Encrypted Parameters </span> <span class="style5">-----  </span><a href="ViewAllCloudData.jsp">Back</a></h2>
         
          <table width="965" border="1" align="center">
  <tr>
    <td width="140" height="32" bgcolor="#FFFFFF"><div align="center" class="style5"><span class="style3">File Name </span></div></td>
      <td width="293" bgcolor="#FFFFFF"><div align="center" class="style5"><span class="style3">Trapdoor </span></div></td>
    <td width="178" bgcolor="#FFFFFF"><div align="center" class="style5"><span class="style3">Secret Key </span></div></td>

	<td width="205" bgcolor="#FFFFFF"><div align="center" class="style5"><span class="style3">OwnerName</span></div></td>
  </tr>
