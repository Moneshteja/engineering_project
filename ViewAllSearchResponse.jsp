...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
          ...
          <h2><span class="style4">View All Response </span> <span class="style5">-----  </span><a href="EndUserMainjsp.jsp">Back</a></h2>
...
<%
      	...
      	try 
	{
           ...
           String uname=(String)application.getAttribute("uname");
      	   String query="select * from srequest where user='"+uname+"'  "; 
