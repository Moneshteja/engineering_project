...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
          ...
          <h2><span class="style4">View All Transactions </span> <span class="style5">-----  </span><a href="CloudServerMain.html">Back</a></h2>
         
          <table width="966" border="1" align="center">
  <tr>
    <td width="159" height="31" bgcolor="#FFFF00"><div align="center" class="style5"><span class="style3">User Name </span></div></td>
      <td width="216" bgcolor="#FFFF00"><div align="center" class="style5"><span class="style3">File Name </span></div></td>
    <td width="207" bgcolor="#FFFF00"><div align="center" class="style5"><span class="style3">Secret Key </span></div></td>
    <td width="162" bgcolor="#FFFF00"><div align="center" class="style5"><span class="style3">Operation</span></div></td>
    <td width="188" bgcolor="#FFFF00"><div align="center" class="style5"><span class="style3">Date & Time</span></div></td>
  </tr>
