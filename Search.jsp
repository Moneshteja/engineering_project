...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
          ...
          <h2><span class="style4">Enter the Keywork to Search Similar Contents  </span> <span class="style5">-----  </span><a href="EndUserMainjsp.jsp">Back</a></h2>
         
           <form id="form1" name="form1" method="post" action="Search1.jsp">
            <p>&nbsp;</p>
            <p><span class="style5">Enter Multi Keyword To Search </span>
