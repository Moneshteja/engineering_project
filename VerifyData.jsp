...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
          ...
          <h2><span class="style4">Verify Your Data File </span> <span class="style5">By Trapdoor -----  </span><a href="CloudServerMain.html">Back</a></h2>
         
          
          <form id="form1" name="form1" method="post" action="ConfirmVerifyData.jsp">
          <table width="598" border="1" align="center" cellpadding="10" cellspacing="0">
            ...
            <tr>
              ...
              <td><input name="Submit" type="submit" class="style4" value="Verify Your Data by Trapdoor" /></td>
            </tr>
          </table>
          </form>
