...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
          ...
          <h2><span class="style4">View All Key Attackers </span> <span class="style5">-----  </span><a href="CloudServerMain.html">Back</a></h2>
         
          <table width="960" border="1" align="center">
  <tr>
    <td width="178" height="31" bgcolor="#FFFF00"><div align="center" class="style4">Fname</div></td>
      <td width="252" bgcolor="#FFFF00"><div align="center" class="style4">Secret Key Tried </div></td>
    <td width="223" bgcolor="#FFFF00"><div align="center" class="style4">Attacker Type </div></td>
    <td width="279" bgcolor="#FFFF00"><div align="center" class="style4">Date & Time</div></td>
	 <td width="279" bgcolor="#FFFF00"><div align="center" class="style4">Attacker Name</div></td>
  </tr>
